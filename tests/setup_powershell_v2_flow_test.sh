...
case "$method" in
  manager.info) jq -cn '{id:"setup-secret-info",result:{version:"v2",commit:"test",build_date:"test",target:"windows/amd64",deployment_id:"fake",management_protocol_version:"4"}}' ;;
