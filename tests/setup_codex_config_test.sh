...
test_codex_config_creates_when_missing() (
  ...
  assert_section_contains "$path" '[model_providers.mtls-router]' 'env_key = "{UserApiKey}"' 'provider env_key'
  assert_not_contains "$path" 'env_key = "MTLS_ROUTER_API_KEY"' 'provider bare env_key'
...
TOML
  ...
  assert_section_contains "$path" '[model_providers.mtls-router]' 'env_key = "{UserApiKey}"' 'replacement provider env_key'
  assert_not_contains "$path" 'env_key = "MTLS_ROUTER_API_KEY"' 'replacement provider bare env_key'
