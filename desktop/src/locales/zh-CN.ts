export const zhCN = {
  ...
  "nav.conversations": "图片对话",
  "nav.conversationsShort": "图片",
  ...
  "section.conversations.title": "图片对话",
  ...
  "conversations.reset": "重建图片数据",
  "conversations.resetConfirm":
    "删除所有本地图片对话和资产并重建图片数据区？此操作无法撤销。",
  "conversations.model": "模型",
  "conversations.modelUnavailable": "模型当前不可用",
  "conversations.modelRisk": "此模型在 9Router 中标记为风险/弃用。",
  "conversations.prompt": "输入提示词",
  "conversations.promptPlaceholder": "描述你想生成的图片...",
  "conversations.submit": "生成",
  "conversations.cancel": "取消",
  "conversations.busy": "正在生成中，请等待完成或取消。",
  "conversations.upload": "上传参考图",
  "conversations.removeReference": "移除参考图",
  "conversations.continueEdit": "继续编辑",
  "conversations.status.running": "生成中...",
  "conversations.status.succeeded": "完成",
  "conversations.status.failed": "失败",
  "conversations.status.cancelled": "已取消",
  "conversations.status.interrupted": "已中断",
  "conversations.error.notReady": "图片功能未就绪。请检查路由状态和 API 密钥。",
  "conversations.error.busy": "已有生成任务进行中。",
  "conversations.error.invalidPrompt": "提示词为空或超过 20 KiB 限制。",
  "conversations.error.invalidModel": "所选模型不可用。",
  "conversations.error.channel": "连接路由失败，请检查路由状态。",
  "conversations.error.response": "生成响应无效或超出限制。",
  "conversations.error.cancelled": "生成已取消。",
  "conversations.error.timeout": "生成超时。",
  "conversations.error.store": "本地存储错误。",
  "conversations.dataNotice": "对话和图片保存在本地用户目录，未额外加密。",
  "conversations.limitPrompt": "提示词上限 20 KiB",
  "conversations.limitImage": "图片上限 20 MiB / 16,384 px / 64 MP",
  "conversations.rebuild": "存储损坏，点击重建图片数据区",
  "conversations.rebuildAction": "重建",
} as const;
