...
export const en: Record<TranslationKey, string> = {
  ...
  "apikey.usage.note":
    "Counts only the saved key, queried through the local router. The interface never reads the key back. Calendar windows start at 08:00 Beijing time (UTC day / ISO week / month boundaries). Provider limits do not change with the usage period.",
  "apikey.usage.periodGroup.rolling": "Rolling",
  "apikey.usage.periodGroup.calendar": "Calendar",
  "apikey.usage.period.1h": "Last 1 hour",
  "apikey.usage.period.12h": "Last 12 hours",
  "apikey.usage.period.24h": "Last 24 hours",
  "apikey.usage.period.7d": "Last 7 days",
  "apikey.usage.period.30d": "Last 30 days",
  "apikey.usage.period.today": "Today (from 08:00)",
  "apikey.usage.period.this_week": "This week (from Mon 08:00)",
  "apikey.usage.period.this_month": "This month (from the 1st 08:00)",
  "apikey.usage.refresh": "Refresh usage",
  "apikey.usage.refreshing": "Refreshing...",
  "apikey.usage.needKey":
  ...
  "apikey.usage.metric.completion": "Output",
  "apikey.usage.metric.cost": "Cost",
  "apikey.usage.quota.heading": "Quota",
  "apikey.usage.quota.unlimited": "Unlimited",
  "apikey.usage.quota.remaining": "Remaining",
  "apikey.usage.quota.resets": "Resets (Beijing time)",
  "apikey.usage.quotas.heading": "Provider limits",
  "apikey.usage.quotas.provider.all": "All providers",
  "apikey.usage.quotas.period.day": "Daily",
  "apikey.usage.quotas.period.week": "Weekly",
  "apikey.usage.quotas.period.month": "Monthly",
  ...
  "apikey.usage.error.auth":
    "Usage could not be authorized. Confirm that the saved key is still valid.",
  "apikey.usage.error.invalid": "The usage response could not be used.",
  "apikey.usage.error.request": "Usage could not be loaded. Try again.",
  "apikey.usage.error.router":
    "The local router is not ready, so usage cannot be loaded.",
  "apikey.usage.error.load": "Usage could not be loaded. Try again.",
